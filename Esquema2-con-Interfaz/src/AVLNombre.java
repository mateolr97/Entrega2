public class AVLNombre {
   ...
   public void rotateRight(Node x){
       ...
       if(y!=null){
          ...
          y.setParent(p);
          if(x.getParent()!=null){
                if(x.getParent().getKey().getNombre().compareTo(y.getKey().getNombre())>0){ 
                    x.getParent().setLeft(y);
                }else if(x.getParent().getKey().getNombre().compareTo(y.getKey().getNombre())<0){ 
  ...
  public void rebalanceLeft(Node n){
   ...
   public void rebalance(Node n){
    ...
    public Node find(String x,Node r){
        if(r.getKey().getNombre()==x){
            return r;
        }else if(r.getKey().getNombre().compareTo(x)>0){
            if(r.getLeft()!=null){
   ...
   public void insert(Enemigo k){ 
       ...
       if(this.root==null){
           this.root=x;
            ...
            Node p=new Node();
            p=this.find(k.getNombre(),this.root);
            if(p.getKey().getNombre().compareTo(k.getNombre())>0){ 
                p.setLeft(x);
                p.getLeft().setParent(p);       
            }else if(p.getKey().getNombre().compareTo(k.getNombre())<0){ 
                p.setRight(x);
    ...
    public void insertAVL(Enemigo k){ 
       ...
       this.size++;
       Node n=new Node();
       n=this.find(k.getNombre(),this.root); 
       this.rebalance(n);
    }
   ...
   public Node rightAncestor(Node n){
       if(n.getKey().getNombre().compareTo(n.getParent().getKey().getNombre())<0){ 
           return n.getParent();
       }else{
   ...
   public void delete(Node n){
       ...
       if(n.getRight()==null){
           if(n.getParent().getKey().getNombre().compareTo(n.getKey().getNombre())>0){ 
               n.getParent().setLeft(n.getLeft());
               if(n.getLeft()!=null){
                   n.getLeft().setParent(n.getParent());
               }       
           }else if(n.getParent().getKey().getNombre().compareTo(n.getKey().getNombre())<0){ 
